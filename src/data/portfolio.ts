...
export const projects: Project[] = [
  {
    ...
    media: [
      "./src/assets/gemini/1.png?portrait",
      "./src/assets/gemini/2.png?portrait",
      "./src/assets/gemini/3.png?portrait",
      "./src/assets/gemini/4.png?portrait",
  ...
  // gemini
  {
    ...
    media: [
      "./src/assets/instagram/4.mp4?portrait",
    ],
  ...
  // instagram
  {
    ...
    media: [
      "./src/assets/drawing/1.mp4?landscape",
    ],
  ...
  // drawing
  {
    ...
    media: [
      "./src/assets/allvideodownloader/1.mp4?landscape",
    ],
  ...
  // vdo downloader
  {
    ...
    media: [
      "./src/assets/dashboard/1.png?landscape",
      "./src/assets/dashboard/2.png?landscape",
      "./src/assets/dashboard/3.png?landscape",
      "./src/assets/dashboard/4.png?landscape",
      "./src/assets/dashboard/5.png?landscape",
      "./src/assets/dashboard/6.png?landscape",
      "./src/assets/dashboard/7.png?landscape",
      "./src/assets/dashboard/8.png?landscape",
      "./src/assets/dashboard/9.png?landscape",
      "./src/assets/dashboard/10.png?landscape",
      "./src/assets/dashboard/11.png?landscape",
    ],
    codeUrl: "https://github.com/",
  },
  // dashboard
  ...
  // social media management
  {
    ...
    media: [
      "./src/assets/downloader chrome extension/1.png?landscape",
    ],
  ...
  // chrome extension
  {
    ...
    media: [
      "./src/assets/tictactoe/1.mp4?landscape",
  ...
  // tictactoe
  {
    ...
    media: [
      "./src/assets/saveimg/1.mp4?landscape",
    ],
  ...
  // network capture
  {
    ...
    media: [
      "./src/assets/airport city/1.mp4?landscape",
    ],
  ...
  // google image scraper
  {
    ...
    media: [
      "./src/assets/news scraper/1.jpg?landscape",
      "./src/assets/news scraper/2.png?landscape",
      "./src/assets/news scraper/3.png?landscape",
      "./src/assets/news scraper/4.png?landscape",
    ],
    codeUrl: "https://github.com/",
  },
  // news scraper
  {
    ...
    media: [
      "./src/assets/snake game/1.png?portrait",
      "./src/assets/snake game/2.png?portrait",
      "./src/assets/snake game/3.mp4?landscape",
    ],
  ...
  // snake game
  {
    ...
    media: [
      "./src/assets/e commerce/1.png?landscape",
      "./src/assets/e commerce/2.png?landscape",
      "./src/assets/e commerce/3.png?landscape",
      "./src/assets/e commerce/4.png?landscape",
      "./src/assets/e commerce/5.png?landscape",
      "./src/assets/e commerce/6.png?landscape",
      "./src/assets/e commerce/7.png?landscape",
    ],
  ...
  // e-commerce
  {
    ...
    skills: ["HTML", "CSS", "JavaScript"],
    media: [
      "./src/assets/image editor/1.mp4?landscape",
      "./src/assets/image editor/2.mp4?portrait",
    ],
  ...
  // image editor
  {
    ...
    media: [
      "./src/assets/chat app/1.png?landscape",
      "./src/assets/chat app/2.png?landscape",
      "./src/assets/chat app/3.png?landscape",
      "./src/assets/chat app/4.png?landscape",
      "./src/assets/chat app/5.png?landscape",
      "./src/assets/chat app/6.png?landscape",
      "./src/assets/chat app/7.png?landscape",
      "./src/assets/chat app/8.png?landscape",
      "./src/assets/chat app/9.png?landscape",
      "./src/assets/chat app/10.png?landscape",
    ],
  ...
  // chat app
  {
    ...
    media: [
      "./src/assets/password gen/1.jpg?landscape",
      "./src/assets/password gen/2.jpg?landscape",
    ],
    codeUrl: "https://github.com/",
  },
  // password gen
  {
    ...
    media: [
      "./src/assets/arduino car/1.mp4?landscape",
    ],
  },
  // arduino car
